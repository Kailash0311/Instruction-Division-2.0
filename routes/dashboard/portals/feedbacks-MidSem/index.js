    ...
    feedbacksModel.create(dataStore, function(err, response) {
      ...
      mailer.send({
        ...
        body:
          ...
          feedbackMidsem2 +
          "</p><br><p>You may access all your feedbacks from the AUGS Division Dashboard by visiting the website.</p>"
      });
